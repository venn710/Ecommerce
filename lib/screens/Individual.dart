                          ...
                          child: Row(
                            children: [
                              ...
                              Expanded(
                                flex: 5,
                                child:GestureDetector(
                                  onTap: ()=>Navigator.push(context,MaterialPageRoute(builder: (context)=>Paymants(finprods:[Product(brand: widget.p2.brand,desc: widget.p2.desc,price: widget.p2.price,title: widget.p2.title,id: widget.p2.id,image: widget.p2.image,size: widget.p2.size,quant:quant)],number_of_products:quant,total_amount: (widget.p2.price)*(quant),))),
                                  child: Material(
                                    color: Colors.white,
                                    borderRadius: BorderRadius.circular(30),child: Padding(
                                  padding: const EdgeInsets.all(8.0),
